...
Word Bank:
A) cautiously     E) effectively     I) phenomenon    M) solution
B) commit         F) increased       J) preventing    N) sufficient
C) control        G) involved        K) sensitive      O) vigorous
D) cycling        H) limited         L) slowing
```
...
One in 10 buyers ranked toilet rolls made from recycled paper among their top considerations, highlighting how overall the environment is much less of a consideration for shoppers than product quality. In a challenge for manufacturers, 81% of paper product users said they would consider buying recycled toilet tissue if it were comparable in quality to standard paper.
```

46. The market sales of toilet paper have decreased because _______.
...
54. The idea of "a marathon" (Line 2, Para. 5) illustrates the popular belief that quitting smoking _______.
