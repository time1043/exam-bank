...
> 温馨提示：2021 年 6 月四级考试全国共考了三套真题，其中第三套真题的听力试题与前两套内容相同，只是选项顺序不同，故听力部分不再重复列出。
...
I've been asked to rate my "store experience" on the EFTPOS terminal before I can pay. Even the most __26__ activities, such as calling Telstra or picking up a parcel from Australia Post, are followed by texts or emails with surveys asking, "How did we do?"

Online purchases are __27__ followed up by a customer satisfaction survey. Companies are so __28__ for a hit of stars that if you delete the survey the company sends you another one.

We're __29__ to rate our apps when we've barely had a chance to use them. One online course provider I use asks you what you think of the course after you've only completed __30__ 2 per cent of it.

Economist Jason Murphy says that companies use customer satisfaction ratings because a __31__ display of star feedback has become the nuclear power sources of the modern economy.

However, you can't help but __32__ if these companies are basing their business on fabrications. I __33__ that with online surveys I just click the __34__ that's closest to my mouse cursor to get the thing off my screen. Often the star rating I give has far more to do with the kind of day I'm having than the purchase I just made.

Word Bank:
A) announce        B) commonplace     C) confess         D) desperate       E) experience
F) fascinated       G) option          H) prompted        I) roughly          J) routinely
K) shining          L) showering        M) variety         N) voyage          O) wonder
```
...
```
中国汉族人的全名由姓和名组成。中文名字的特点是姓在前，名在后。例如，姓名王小明中，"王"是姓，"小明"是名。中文名字通常有含义，有时包含出生地和出生时间等信息。如今，许多中国父母在给孩子取名字时也会考虑名字的发音。有些父母选择一个听起来与英文名相似的中文名字，以便于外国人记住。
```
