...
1 0 . A ) It is usually caused by a stroke or brain injury.
...
1 1 . A ) British. B) Irish. C ) Russian. D ) Australian.
```

**Questions 12 to 15 are based on the passage you have just heard.**

```
1 2 . A) Water sports. C) Stories about women swimmers.
B) Racing in rivers. D) Books about swimming.
1 3 . A) She succeeded in swimming across the English Channel.
...
1 5 . A) She designed lots of appropriate swimwear for women.
...
```
1 6 . A) Build a machine that can detect lies.
B) Develop a magnetic brain scanner.
C) Test the credibility of court evidence.
D) Win people's complete trust in them.
1 7 . A) They are optimistic about its potential. C) They think it is but business promotion.
B) They are sceptical of its reliability. D) They celebrate it with great enthusiasm.
1 8 . A)It is not to be trusted at all. C) It may intrude into people's privacy.
...
```
1 9 . A) Most of its residents speak several languages.
...
2 1 . A) They used different methods to collect and analyze data.
...
College professors are increasingly 3 1 alarm bells about the effects smartphones, laptops,
and tablets have on academic performance. One 20 1 3 study of college students found that 80% of
students use their phones or laptops during class, with the average student checking their digital
device 1 1 times in a 32 class. A quarter of students report that their use of digital devices during
...
3 8 . Merian's masterpiece came under attack a century after its publication.
...
4 1 . Merian acknowledged the help she got from natives of South America.
...
Numeracy 1 0 1 . There, his students of " citizen statistics" learn to analyze public information like the
...
48. What does Andrew Hacker's Numeracy 1 0 1 aim to do ?
...
other items, and retrieve records. It fo llows a specific individual, such as a doctor or nurse, who can
...
home to visit grandma, you can use a telepresence robot to hang out with her. A 20 1 6 study found
...
5 1 . What does the author say about Japan?
...
**Directions:** For this part , you are allowed 30 minutes to translate a passage from Chinese into English. You should write your answer on Answer Sheet 2. � oo•*•ma0�00�ffi , *•�Afil�%� ��fflo �ili0� ��tt�*�OO , � OO �0�00�ffi�-���m*o W�OO�ffi�MR���@ , ��*��T£��ff.ffm� ��0 *�0�00�ffi�&-�#�-� �#��� , WH�M*��� --��ffl�o ili� * , �ili�TW��*OO�ffl , MW�� T#�OO��- �� � o -@ OO�ffi�-ili T � mm g}¥� , 1tii*1\\'f���£:iJ0:1r1£ , :it!:-:$-nWJE Til*�->lt a

## Part I Writing （30 minutes）

```
cii-=.F iE � * :,f s =If.,1, a.t l*J � J.oc if< ruHt , z. s � i1:H,-n1r :n :,f i.it)
```
