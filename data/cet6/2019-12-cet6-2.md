...
1 0 . A) Their urge to make farming more enjoyable.
...
```
1 2 . A) It has turned certain insects into a new food source.
...
```
1 6 . A) To categorize different types of learners.
...
1 7 . A) It was defective. C) It was original in design.
...
```
1 9 . A) Not playing a role in a workplace revolution.
...
2 1 . A) Loss of workers' personal dignity.
...
is 30 , while brakes, tyres and roads all create tiny airborne 3 1 as they wear out.
...
vehicle use has reached its 3 3 and will decline, but transport planners have yet to catch up with
...
doubling the size of a road can 3 5 double the traffic, taking us back to the starting point.
...
3 8 . The protein supplement business is found to be thriving.
...
4 1 . Older adults need to take in more protein to keep their muscles strong.
...
the Ross Sea in 20 1 6 , another reserve is being proposed in a vast area of the Weddell Sea, and a third
...
**Directions:** For this part , you are allowed 30 minutes to translate a passage from Chinese into English. You should write your answer on Answer Sheet 2. ffi:tt ( plum blossom) 1irns- 9'1 IE --t:k� :ttz:. e , ml r 9'1 !E m ::ir , B :lf =:: ct � 1:p s� � :l:'1'i- ;¥o # ffi JJi� 0 �� st 11 ' nWU, � �ffi:tt�ll!F� ' ill!wJxl *{1Jt��pj: 0 1:1: 9'1 00 ��Jt 1.-t 9'1 ' ffi:tt� fil w.111B.1 , � ra, rWift , �JJw .A.fn �ll!xl.t�tL!il\Ji.mfrrfi O § it W3lt , w�ff.A.-fil llID �� m:tt 9'1 � J&� O tfim:kikmt�JB!ffi:tt ' *11AA i's] 1lt ffl r�JJ!Yittffl O mffim B )[4}� ' iUfF T :3c��*1 B�1tlfb ffi:tt5E"7 m :tt , �1:p�,JJ,ffi:tt11 , nx: et ...t:n s� .A. � wF� ¥LI ffi:tt w ff'Jt§'5t#lto
